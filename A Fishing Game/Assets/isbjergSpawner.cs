...
public class isbjergSpawner : MonoBehaviour
{
    ...
    public GameObject[] isbjerg =new GameObject[3];
    ...
    void Update()
    {
        ...
        {
          GameObject tmp = Instantiate(isbjerg,new Vector3(Random.Range(-350,350),0, 350),Quaternion.identity);
            GameObject tmp2 = Instantiate(isbjerg, new Vector3(Random.Range(-350, 350), 0, -350), Quaternion.identity);
        ...
        */
        ...
        if (timer2> timeBetweenSpawns2)
        {
            ...
            GameObject tmp5 = Instantiate(isbjerg[Random.Range(0,isbjerg.Length)], boat.transform.position + boat.transform.forward * 350, Quaternion.identity);
